      ...
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-12 lg:items-end">
        ...
        {rank2 && (
          <motion.div
            ...
            tabIndex={0}
            role="button"
            className="group cursor-pointer rounded-xl border border-slate-700/60 bg-[#080d19] p-5 shadow-lg lg:col-span-4 hover:border-slate-400 transition-all focus-ring"
          >
        ...
        {/* RANK 1 (Center / Visually Dominant) */}
        {rank1 && (
          <motion.div
            ...
            tabIndex={0}
            role="button"
            className="group cursor-pointer rounded-2xl border-2 border-orange-500/60 bg-gradient-to-b from-orange-500/15 via-[#0b101d] to-[#080d19] p-6 shadow-2xl shadow-orange-500/10 lg:col-span-4 lg:-translate-y-2 hover:border-orange-400 transition-all focus-ring"
          >
        ...
        {rank3 && (
          <motion.div
            ...
            tabIndex={0}
            role="button"
            className="group cursor-pointer rounded-xl border border-sky-500/30 bg-[#080d19] p-5 shadow-lg lg:col-span-4 hover:border-sky-400 transition-all focus-ring"
          >
            <div className="flex items-start justify-between border-b border-white/[0.08] pb-3">
